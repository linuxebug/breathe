...
BOT_STATUS_NAME = os.getenv('BOT_STATUS_NAME', 'Breathe Cloud')
WATERMARK = os.getenv('WATERMARK', 'Breathe Cloud Team')
...
VPS_HOSTNAME = os.getenv('VPS_HOSTNAME', 'breathe-vps')  # Base hostname, append user ID
...
async def about(interaction: discord.Interaction):
    ...
    embed.add_field(
        ...
        value=(
            ...
            "💬 **Discord Support:** [Join Breathe Cloud Support](https://discord.gg/zC3xHcnj8r)"
        ),
        inline=False
    )
...
async def help_cmd(interaction: discord.Interaction):
    embed = discord.Embed(title="Breathe Cloud - Help", color=discord.Color.blue(), timestamp=datetime.now(timezone.utc))
    embed.set_author(name=bot.user.name, icon_url=bot.user.avatar.url if bot.user.avatar else None)
    embed.set_footer(text=WATERMARK, icon_url=bot.user.avatar.url if bot.user.avatar else None)
